...
public class PainelFilmes extends JPanel {
	...
	private static Logger LOG = Logger.getLogger(PainelFilmes.class);
	...
	public PainelFilmes() {
		icone = new ImageIcon(Resource.getImageResourcePath()+"ic_tab_filmes.png");
	...
	private class TratadorDeEventos extends MouseAdapter implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == btnProcurar){
				DefaultTableModel model = controller.procurarFilme(
	...
	public void setController(CCadastroFilmes controller){
